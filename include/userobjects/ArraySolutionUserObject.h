 ...
 */
class ArraySolutionUserObject : public GeneralUserObject
{
public:
  static InputParameters validParams();

  ArraySolutionUserObject(const InputParameters & parameters);
  virtual ~ArraySolutionUserObject(); // empty dtor required for unique_ptr with forward declarations
