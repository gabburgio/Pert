...
[./albedo]
    ...
    gamma_factors = ' 0.648758 0.755971 1.28573 0.115444'
...
[./gcu_F9plug]
	...
	sph_factors = '0.619464 0.88015  1.0391   0.542706'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_F8graph]
	block = 'F8graph'
	type = CorrectedNuclearMaterial
	sph_factors = '0.62386  0.919452 1.09128  0.667419'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_F7rifl]
	block = 'F7rifl'
	type = CorrectedNuclearMaterial
	sph_factors = '0.652887 0.832969 1.0005   0.904478'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR396]
	block = 'MNR396'
	type = CorrectedNuclearMaterial
	sph_factors = '1.03807  1.03513  1.00991  0.953988'
...
[./gcu_MNR375]
	block = 'MNR375'
	type = CorrectedNuclearMaterial
	sph_factors = '1.04372 1.03538 1.02782 1.28227'
...
[./gcu_MNR374]
	block = 'MNR374'
	type = CorrectedNuclearMaterial
	sph_factors = '1.01549 1.00899 1.00775 1.48602'
...
[./gcu_MNR372]
	block = 'MNR372'
	type = CorrectedNuclearMaterial
	sph_factors = '1.04207 1.0115  1.00428 1.70543'
...
[./gcu_MNR382]
	block = 'MNR382'
	type = CorrectedNuclearMaterial
	sph_factors = '1.03045  0.992631 0.982777 2.08205 '
...
[./gcu_MNR389]
	block = 'MNR389'
	type = CorrectedNuclearMaterial
	sph_factors = '0.959328 0.95787  0.952722 2.59557 '
...
[./gcu_E9rifl]
	block = 'E9rifl'
	type = CorrectedNuclearMaterial
	sph_factors = '0.647095 0.880471 0.999279 0.530955'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_E8graph]
	block = 'E8graph'
	type = CorrectedNuclearMaterial
	sph_factors = '0.682904 0.953718 1.06966  0.64839 '
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR394]
	block = 'MNR394'
	type = CorrectedNuclearMaterial
	sph_factors = '1.09097  1.12067  1.06056  0.557604'
...
[./gcu_MNRC77]
	block = 'MNRC77'
	type = CorrectedNuclearMaterial
	sph_factors = '0.90953  0.96336  1.00861  0.934514'
...
[./gcu_MNR377]
	block = 'MNR377'
	type = CorrectedNuclearMaterial
	sph_factors = '1.16229 1.09508 1.0604  1.01825'
...
[./gcu_MNRC76]
	block = 'MNRC76'
	type = CorrectedNuclearMaterial
	sph_factors = '0.963803 0.973453 1.0046   1.34259 '
...
[./gcu_MNR395]
	block = 'MNR395'
	type = CorrectedNuclearMaterial
	sph_factors = '1.23929 1.11703 1.05445 1.31099'
...
[./gcu_MNRC80]
	block = 'MNRC80'
	type = CorrectedNuclearMaterial
	sph_factors = '0.982934 0.961908 1.01329  2.11178 '
...
[./gcu_MNR387]
	block = 'MNR387'
	type = CorrectedNuclearMaterial
	sph_factors = '1.03383  0.995861 0.980708 2.03583 '
...
[./gcu_D9graph]
	block = 'D9graph'
	type = CorrectedNuclearMaterial
	sph_factors = '0.642959 0.898579 0.986314 0.519635'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_D8graph]
	block = 'D8graph'
	type = CorrectedNuclearMaterial
	sph_factors = '0.642392 0.92322  1.05876  0.663509'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_D7rifl]
	block = 'D7rifl'
	type = CorrectedNuclearMaterial
	sph_factors = '0.757629 0.90701  1.03931  0.834423'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR392]
	block = 'MNR392'
	type = CorrectedNuclearMaterial
	sph_factors = '1.19065  1.13354  1.0731   0.724826'
...
[./gcu_MNR381]
	block = 'MNR381'
	type = CorrectedNuclearMaterial
	sph_factors = '1.2476   1.15954  1.09     0.882164'
...
[./gcu_MNR391]
	block = 'MNR391'
	type = CorrectedNuclearMaterial
	sph_factors = '1.2835  1.16334 1.08949 1.00677'
...
[./gcu_MNR388]
	block = 'MNR388'
	type = CorrectedNuclearMaterial
	sph_factors = '1.27234 1.14145 1.07829 1.21463'
...
[./gcu_MNR378]
	block = 'MNR378'
	type = CorrectedNuclearMaterial
	sph_factors = '1.15185 1.0708  1.04029 1.51665'
...
[./gcu_MNR390]
	block = 'MNR390'
	type = CorrectedNuclearMaterial
	sph_factors = '1.06161  1.02103  0.999278 1.77079 '
...
[./gcu_C9rifl]
	block = 'C9rifl'
	type = CorrectedNuclearMaterial
	sph_factors = '0.621194 0.839182 0.951139 0.534411'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_C8graph]
	block = 'C8graph'
	type = CorrectedNuclearMaterial
	sph_factors = '0.683753 0.93413  1.04832  0.659911'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR379]
	block = 'MNR379'
	type = CorrectedNuclearMaterial
	sph_factors = '1.07915  1.1107   1.08965  0.604923'
...
[./gcu_MNR393]
	block = 'MNR393'
	type = CorrectedNuclearMaterial
	sph_factors = '1.21378  1.15866  1.08889  0.728304'
...
[./gcu_010400]
	block = 'u10400'
	type = CorrectedNuclearMaterial
	sph_factors = '0.793911 0.877683 1.02474  1.48025 '
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR384]
	block = 'MNR384'
	type = CorrectedNuclearMaterial
	sph_factors = '1.26671 1.16042 1.08907 1.00762'
...
[./gcu_MNR383]
	block = 'MNR383'
	type = CorrectedNuclearMaterial
	sph_factors = '1.22774 1.1293  1.08128 1.20668'
...
[./gcu_MNRC74]
	block = 'MNRC74'
	type = CorrectedNuclearMaterial
	sph_factors = '0.902293 0.94213  0.994493 1.62448 '
...
[./gcu_MNR361]
	block = 'MNR361'
	type = CorrectedNuclearMaterial
	sph_factors = '0.965647 0.974086 0.991749 1.81236 '
...
[./gcu_B9plug]
	block = 'B9plug'
	type = CorrectedNuclearMaterial
	sph_factors = '0.557125 0.792202 0.920181 0.569979'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_B8graph]
	block = 'B8graph'
	type = CorrectedNuclearMaterial
	sph_factors = '0.680822 0.932762 1.06837  0.703797'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR398]
	block = 'MNR398'
	type = CorrectedNuclearMaterial
	sph_factors = '1.0994   1.12106  1.09544  0.613064'
...
[./gcu_MNRC79]
	block = 'MNRC79'
	type = CorrectedNuclearMaterial
	sph_factors = '0.966568 1.01818  1.05063  0.919017'
...
[./gcu_MNR385]
	block = 'MNR385'
	type = CorrectedNuclearMaterial
	sph_factors = '1.21509  1.16359  1.09824  0.909173'
...
[./gcu_MNRC78]
	block = 'MNRC78'
	type = CorrectedNuclearMaterial
	sph_factors = '0.966148 1.00494  1.03882  1.25962 '
...
[./gcu_MNR358]
	block = 'MNR358'
	type = CorrectedNuclearMaterial
	sph_factors = '1.12351 1.08699 1.07396 1.32408'
...
[./gcu_MNR373]
	block = 'MNR373'
	type = CorrectedNuclearMaterial
	sph_factors = '1.08174 1.06836 1.06562 1.48692'
...
[./gcu_MNR365]
	block = 'MNR365'
	type = CorrectedNuclearMaterial
	sph_factors = '0.970201 0.981157 1.00019  1.77648 '
...
[./gcu_A9plug]
	block = 'A9plug'
	type = CorrectedNuclearMaterial
	sph_factors = '0.756423 1.14882  1.28176  0.593165'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_A8graph]
	block = 'A8graph'
	type = CorrectedNuclearMaterial
	sph_factors = '0.640186 0.94762  1.13329  0.716396'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_A7rifl]
	block = 'A7rifl'
	type = CorrectedNuclearMaterial
	sph_factors = '0.670852 0.858266 1.03221  0.954591'
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR397]
	block = 'MNR397'
	type = CorrectedNuclearMaterial
	sph_factors = '1.06579 1.06884 1.05599 1.0446 '
...
[./gcu_MNR376]
	block = 'MNR376'
	type = CorrectedNuclearMaterial
	sph_factors = '1.06639 1.07379 1.08024 1.41666'
...
[./gcu_MNR366]
	block = 'MNR366'
	type = CorrectedNuclearMaterial
	sph_factors = '1.00891 1.03493 1.05629 1.59006'
...
[./gcu_MNR362]
	block = 'MNR362'
	type = CorrectedNuclearMaterial
	sph_factors = '1.00577 1.03952 1.0588  1.56417'
...
[./gcu_010500]
	block = 'u10500'
	type = CorrectedNuclearMaterial
	sph_factors = '0.706748 0.951696 1.04482  1.99854 '
 	nu_sigma_f = '0. 0. 0. 0.'
...
[./gcu_MNR369]
	block = 'MNR369'
	type = CorrectedNuclearMaterial
	sph_factors = '0.918803 0.943904 0.976023 1.86181 '
