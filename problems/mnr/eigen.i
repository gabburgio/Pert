...
[./F9plug_u]
    ...
    chi = '0. 0.'
    sigma_s = '8.54351e-01 5.28200e-05; 0.0637091 3.02632  '
[]
[./F8graph_u]
    block = 'F8graph_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.02757e-01 5.69281e-05; 0.0222062 1.32062  '
[]
[./F7rifl_u]
    block = 'F7rifl_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '4.98174e-01 7.80648e-05; 0.0300786 1.72442  '
[]
[./MNR396]
    block = 'MNR396'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.69611e-01 2.10007e-04; 0.0253346 1.8843   '
[]
[./MNR375]
    block = 'MNR375'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.78396e-01 2.14087e-04; 0.0262242 1.89817  '
[]
[./MNR374]
    block = 'MNR374'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.81802e-01 2.05521e-04; 0.0267509 1.89959  '
[]
[./MNR372]
    block = 'MNR372'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.79722e-01 2.16818e-04; 0.0263273 1.91329  '
[]
[./MNR382]
    block = 'MNR382'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.76599e-01 2.21653e-04; 0.0260312 1.89332  '
[]
[./MNR389]
    block = 'MNR389'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.71658e-01 2.10318e-04; 0.0255032 1.90812  '
[]
[./E9rifl_u]
    block = 'E9rifl_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.08132e-01 3.34563e-05; 0.0370149 1.73528  '
[]
[./E8graph_u]
    block = 'E8graph_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.00290e-01 6.99679e-05; 0.0205297 1.31748  '
[]
[./MNR394]
    block = 'MNR394'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.69840e-01 1.96464e-04; 0.0255134 1.89721  '
[]
[./MNRC77]
    block = 'MNRC77'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '6.02054e-01 1.98019e-04; 0.0286993 2.04216  '
[]
[./MNR377]
    block = 'MNR377'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.80717e-01 2.51307e-04; 0.0262038 1.91107  '
[]
[./MNRC76]
    block = 'MNRC76'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '6.04156e-01 2.06590e-04; 0.02896 2.04651'
[]
[./MNR395]
    block = 'MNR395'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.76920e-01 2.76473e-04; 0.025672 1.90897 '
[]
[./MNRC80]
    block = 'MNRC80'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '6.00885e-01 2.19731e-04; 0.0291992 2.01053  '
[]
[./MNR387]
    block = 'MNR387'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.75186e-01 2.34233e-04; 0.0256611 1.93007  '
[]
[./D9graph_u]
    block = 'D9graph_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.06501e-01 3.88472e-05; 0.0245312 1.3236   '
[]
[./D8graph_u]
    block = 'D8graph_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.07704e-01 6.91790e-05; 0.0221412 1.32831  '
[]
[./D7rifl_u]
    block = 'D7rifl_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '4.99559e-01 9.94126e-05; 0.0296495 1.72838  '
[]
[./MNR392]
    block = 'MNR392'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.74674e-01 2.43025e-04; 0.0256448 1.91818  '
[]
[./MNR381]
    block = 'MNR381'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.78905e-01 2.25891e-04; 0.0260984 1.89819  '
[]
[./MNR391]
    block = 'MNR391'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.79573e-01 2.63385e-04; 0.0258958 1.90514  '
[]
[./MNR388]
    block = 'MNR388'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.80532e-01 2.65643e-04; 0.0259899 1.92236  '
[]
[./MNR378]
    block = 'MNR378'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.83185e-01 2.43993e-04; 0.0265066 1.90749  '
[]
[./MNR390]
    block = 'MNR390'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.75277e-01 2.28664e-04; 0.0257534 1.92477  '
[]
[./C9rifl_u]
    block = 'C9rifl_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.12555e-01 3.78420e-05; 0.0374051 1.74231  '
[]
[./C8graph_u]
    block = 'C8graph_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.02804e-01 7.44662e-05; 0.0206575 1.31718  '
[]
[./MNR379]
    block = 'MNR379'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.79878e-01 2.12166e-04; 0.0263183 1.92795  '
[]
[./MNR393]
    block = 'MNR393'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.72211e-01 2.32806e-04; 0.0254357 1.92497  '
[]
[./010400]
    block = '010400'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '8.07005e-01 1.38515e-04; 0.0498504 2.7625   '
[]
[./MNR384]
    block = 'MNR384'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.76205e-01 2.39981e-04; 0.0258737 1.92472  '
[]
[./MNR383]
    block = 'MNR383'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.81918e-01 2.57954e-04; 0.0263514 1.92152  '
[]
[./MNRC74]
    block = 'MNRC74'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '6.05735e-01 1.88627e-04; 0.0294049 2.04904  '
[]
[./MNR361]
    block = 'MNR361'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.81547e-01 2.04085e-04; 0.0269128 1.94216  '
[]
[./B9plug_u]
    block = 'B9plug_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '8.72494e-01 5.64986e-05; 0.0657485 3.045    '
[]
[./B8graph_u]
    block = 'B8graph_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.01906e-01 7.35707e-05; 0.0204217 1.31373  '
[]
[./MNR398]
    block = 'MNR398'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.73479e-01 2.24878e-04; 0.0254885 1.89957  '
[]
[./MNRC79]
    block = 'MNRC79'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.97491e-01 2.03160e-04; 0.0279661 2.02897  '
[]
[./MNR385]
    block = 'MNR385'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.74513e-01 2.22611e-04; 0.0257051 1.87444  '
[]
[./MNRC78]
    block = 'MNRC78'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '6.01585e-01 1.92775e-04; 0.0287746 2.03496  '
[]
[./MNR358]
    block = 'MNR358'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.86382e-01 2.27730e-04; 0.0270483 1.93172  '
[]
[./MNR373]
    block = 'MNR373'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.88560e-01 2.22207e-04; 0.0271102 1.9079   '
[]
[./MNR365]
    block = 'MNR365'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.8142e-01 1.9251e-04; 0.0266971 1.93594  '
[]
[./A9plug_u]
    block = 'A9plug_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '8.72414e-01 5.66321e-05; 0.0656685 3.03089  '
[]
[./A8graph_u]
    block = 'A8graph_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.11183e-01 6.07797e-05; 0.0229796 1.32602  '
[]
[./A7rifl_u]
    block = 'A7rifl_u'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '5.04672e-01 8.45980e-05; 0.0310279 1.72495  '
[]
[./MNR397]
    block = 'MNR397'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.76125e-01 2.28328e-04; 0.0260734 1.90684  '
[]
[./MNR376]
    block = 'MNR376'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.84392e-01 2.23568e-04; 0.0268941 1.92142  '
[]
[./MNR366]
    block = 'MNR366'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.89497e-01 1.99027e-04; 0.0278026 1.92331  '
[]
[./MNR362]
    block = 'MNR362'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.93193e-01 1.93510e-04; 0.0282495 1.9399   '
[]
[./010500]
    block = '010500'
    type = NuclearMaterial
    ...
    chi = '0. 0.'
    sigma_s = '6.39815e-01 1.41657e-04; 0.0169195 1.29417  '
[]
[./MNR369]
    block = 'MNR369'
    type = NuclearMaterial
    ...
    chi = '1. 0.'
    sigma_s = '5.83711e-01 1.70729e-04; 0.0273602 1.93826  '
[]
[]
...
[./albedo] 
    ...
    albedo_matrix = '0.486012 0.138912; 0.0808863 0.744164 '
